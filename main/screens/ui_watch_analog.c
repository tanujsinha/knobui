...
lv_obj_t *ui_watch_analog = NULL;lv_obj_t *ui_bg_2 = NULL;lv_obj_t *ui_clock = NULL;lv_obj_t *ui_dots = NULL;lv_obj_t *ui_battery_group1 = NULL;lv_obj_t *ui_date_group2 = NULL;lv_obj_t *ui_day2 = NULL;lv_obj_t *ui_month2 = NULL;lv_obj_t *ui_year2 = NULL;lv_obj_t *ui_weather_title_group_2 = NULL;lv_obj_t *ui_weather_group_5 = NULL;lv_obj_t *ui_degree_7 = NULL;lv_obj_t *ui_cloud_fog_3 = NULL;lv_obj_t *ui_step_group2 = NULL;lv_obj_t *ui_daily_mission_group1 = NULL;lv_obj_t *ui_button_top1 = NULL;lv_obj_t *ui_button_down1 = NULL;lv_obj_t *ui_clock_group = NULL;lv_obj_t *ui_sec = NULL;lv_obj_t *ui_min = NULL;lv_obj_t *ui_hour = NULL;lv_obj_t *ui_dots_group = NULL;lv_obj_t *ui_dot16 = NULL;lv_obj_t *ui_dot17 = NULL;lv_obj_t *ui_BackButtonWatch = NULL;
// event funtions
...
void ui_event_BackButtonWatch( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);
...
lv_obj_set_x( ui_bg_2, 0 );
lv_obj_set_y( ui_bg_2, -1 );
lv_obj_set_align( ui_bg_2, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_bg_2, LV_OBJ_FLAG_HIDDEN | LV_OBJ_FLAG_ADV_HITTEST );   /// Flags
lv_obj_clear_flag( ui_bg_2, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
lv_img_set_zoom(ui_bg_2,238);
...
ui_BackButtonWatch = lv_btn_create(ui_watch_analog);
lv_obj_set_width( ui_BackButtonWatch, 30);
lv_obj_set_height( ui_BackButtonWatch, 30);
lv_obj_set_x( ui_BackButtonWatch, -150 );
lv_obj_set_y( ui_BackButtonWatch, -150 );
lv_obj_set_align( ui_BackButtonWatch, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_BackButtonWatch, LV_OBJ_FLAG_SCROLL_ON_FOCUS );   /// Flags
lv_obj_clear_flag( ui_BackButtonWatch, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
lv_obj_set_style_bg_color(ui_BackButtonWatch, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_opa(ui_BackButtonWatch, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_bg_img_src( ui_BackButtonWatch, &ui_img_arrow_png, LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_img_recolor(ui_BackButtonWatch, lv_color_hex(0x565656), LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_bg_img_recolor_opa(ui_BackButtonWatch, 255, LV_PART_MAIN| LV_STATE_DEFAULT);

lv_obj_add_event_cb(ui_BackButtonWatch, ui_event_BackButtonWatch, LV_EVENT_ALL, NULL);
