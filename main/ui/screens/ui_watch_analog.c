...
lv_obj_t *ui_watch_analog = NULL;lv_obj_t *ui_bg_2 = NULL;lv_obj_t *ui_clock = NULL;lv_obj_t *ui_dots = NULL;lv_obj_t *ui_battery_group1 = NULL;lv_obj_t *ui_date_group2 = NULL;lv_obj_t *ui_day2 = NULL;lv_obj_t *ui_month2 = NULL;lv_obj_t *ui_year2 = NULL;lv_obj_t *ui_weather_title_group_2 = NULL;lv_obj_t *ui_weather_group_5 = NULL;lv_obj_t *ui_degree_7 = NULL;lv_obj_t *ui_cloud_fog_3 = NULL;lv_obj_t *ui_step_group2 = NULL;lv_obj_t *ui_daily_mission_group1 = NULL;lv_obj_t *ui_button_top1 = NULL;lv_obj_t *ui_button_down1 = NULL;lv_obj_t *ui_clock_group = NULL;lv_obj_t *ui_sec = NULL;lv_obj_t *ui_min = NULL;lv_obj_t *ui_hour = NULL;lv_obj_t *ui_dots_group = NULL;lv_obj_t *ui_dot16 = NULL;lv_obj_t *ui_dot17 = NULL;
// event funtions
